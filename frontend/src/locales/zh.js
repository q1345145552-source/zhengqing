export default {
  ...
  status: { pendingReview:'待审核', approved:'审核通过', pendingPayment:'待付款', paid:'已付款', warehouseReceiving:'中国仓库收货', inTransit:'运输中', arrivedThailand:'已到泰国仓库', inCustoms:'清关中', released:'已放行', outForDelivery:'已派送', completed:'已完成', rejected:'已退回', draft:'草稿', registered:'已注册' },
  payment: { pending:'待付款', paid:'已付款', failed:'扣款失败', pendingRetry:'扣款失败待充值', amount:'金额', balance:'余额', chargeTime:'扣款时间', autoDeduct:'到达中国仓库时自动扣款', confirmCharge:'确认扣款', totalPayable:'应付金额', chargeSuccess:'扣款成功', refunded:'已退款' },
